 ...
 */
public class NeuralNetClient implements NeuralNetEndpoint {


    public final static String EVALUATION_ENDPOINT = "/v1/neuralnet/evaluate";
    public static NeuralNetClient create(final HttpClient httpClient, final String endpoint) {
        return new NeuralNetClient(httpClient,endpoint);
    }

    private final Logger LOGGER = LoggerFactory.getLogger(NeuralNetClient.class);
    private final String endpoint;
    final HttpClient httpClient;

    public NeuralNetClient(final HttpClient httpClient, final String endpoint) {
