...
my_users = {'fm' : '3.120ca851b92d49cdae5e0e33eb02f171', 
            ...
            'mf' : '3.7976dee8ee464a26861f77d942bd0b9f', 
            'af' : '2.1d8b5016a7384d6784e1787480da5a38'
            }
...
def get_pair_data(pairs, datestr):
    ...
    t0_1 = data1[0]['timestamp']
    t0_2 = data2[0]['timestamp']
    
    t0 = t0_2
    if t0_1 < t0_2:
        t0 = t0_1
        
    tf_1 = data1[-1]['timestamp'] 
    tf_2 = data2[-1]['timestamp']
    ...
    N = (tf - t0) / 1000 / 60 + 1
    t1 = [(item['timestamp'] - t0) / 1000 / 60 for item in data1]
    t2 = [(item['timestamp'] - t0) / 1000 / 60 for item in data2]
