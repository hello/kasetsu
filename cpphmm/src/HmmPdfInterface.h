...
public:
    ...
    virtual HmmPdfInterfaceSharedPtr_t reestimate(const HmmDataVec_t & gammaForThisState, const HmmDataMatrix_t & meas) const = 0;
    virtual HmmPdfInterfaceSharedPtr_t clone(bool isPerturbed) const = 0;
